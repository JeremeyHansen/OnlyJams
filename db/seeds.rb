...
User.create(first_name: "Peter", last_name: "Hansen", username: "tgains", password: "1234", email: "jeremey@gmail.com", phone_number: "(919)-422-1234", profile_picture: "https://assets.mycast.io/posters/the-life-and-documentary-of-paul-miller-fan-casting-poster-123530-medium.jpg?1629341435", birthday: "2/14/88", pronouns: "She/her")
...
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 3, group_id: 3)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 4, group_id: 2)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 3, group_id: 8)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 1, group_id: 10)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 2, group_id: 12)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 5, group_id: 22)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 3, group_id: 12)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 2, group_id: 11)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 1, group_id: 13)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 6, group_id: 4)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 2, group_id: 5)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 6, group_id: 5)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 4, group_id: 3)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 3, group_id: 2)
Post.create(post: "Yo, listen to this song! url...", saves: 0, likes: 1, user_id: 2, group_id: 1)
